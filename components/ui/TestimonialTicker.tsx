          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                {t.verified && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[11px] font-mono-tech font-bold border border-emerald-200">
